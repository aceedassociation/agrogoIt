...
const packages = [
  ...
  { title:"Workflow System Pilot", best:"Organizations with one urgent process to digitize quickly.", problem:"A high-value process is slow, uncontrolled or difficult to trace.", deliverables:["One working web module","User roles and permissions","Workflow and approval logic","Basic management dashboard","User training","Pilot performance measurement"] },
  { title:"Business Website & Portal", best:"Companies needing stronger credibility and structured interactions.", problem:"Requests and customer communication lack a credible, organized digital channel.", deliverables:["Responsive website or portal","Structured service pages","Contact and request forms","Analytics integration","CRM-ready lead handoff","Basic SEO configuration"] },
  { title:"Dolibarr Implementation", best:"SMEs needing ERP and CRM capability without starting from zero.", problem:"Sales, invoicing, stock, purchasing and projects are fragmented.", deliverables:["Dolibarr configuration","Users, roles and permissions","CRM and sales setup","Quotations and invoicing","Products, stock and purchasing","Projects and data migration","Training and support","Custom modules when required"] },
  { title:"Mobile MVP", best:"Customer-facing, member-facing or field-team use cases.", problem:"Users need a reliable workflow away from a desktop environment.", deliverables:["Mobile application","Backend and API","Authentication","Notifications","Analytics","Testing","Deployment support"] },
