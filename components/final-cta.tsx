...
export function FinalCta({ title = "Start with the business problem—not the software.", text = "Tell us what is slowing down your organization. We will help define the right workflow, system and implementation roadmap." }: { title?: string; text?: string }) {
  return (
    <section className="cta-section section-shell">
      ...
      <div className="button-row"><Button asChild size="lg" className="button-white"><Link href="/contact?project=diagnostic" data-analytics-event="book_diagnostic">Book a Digital Diagnostic <ArrowRight /></Link></Button><Button asChild size="lg" variant="outline" className="button-on-dark"><Link href="/contact" data-analytics-event="discuss_project">Discuss Your Project</Link></Button></div>
    </section>
  );
}
